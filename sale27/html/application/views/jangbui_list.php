...
<script>
    function find_text()
	{
		form1.action="/~sale27/jangbui/lists/text1/" + form1.text1.value + "/page";
		form1.submit();
	}
...
?>
                <div class="col-9" align="right">           
                     <a href="/~sale27/jangbui/add<?=$tmp; ?>" class="btn btn-sm mycolor1">추가</a>
                </div>
            </div>
        </form>
...
?>
			<tr>
				...
				<td align="left"><a href="/~sale27/jangbui/view/no/<?=$no; ?><?=$tmp; ?>"><?=$row->product_name; ?></a></td>
				<td align="right"><?=number_format($row->price27); ?></td>
				<td align="right"><?=number_format($row->numi27); ?></td>
