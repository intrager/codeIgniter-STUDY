        <br>
        <div class="alert mycolor1" role="alert">음원 추가</div>
<script>
	function find_product()
	{
        ...
        <form name="form1" method="post" action="" class="form-inline">
			...
			<tr>
				...
				<td width="80%" align="left">
					<div class="form-inline">
						<input type="hidden" name="record_no" value="<?=set_value("singer_no"); ?>">
						<input type="text" name="record_name" value="" 
			...
			<tr>
				...
				<td width="80%" align="left">
					<div class="form-inline">
						<input type="text" name="video" value="<?=set_value("video"); ?>" class="form-control form-control-sm" />
					</div>
