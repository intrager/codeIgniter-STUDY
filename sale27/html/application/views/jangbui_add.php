...
<?
	...
	foreach ($list as $row)
	{
		if ($row->no27==$product_no)
			echo("<option value='$row->no27^^$row->price27' selected>$row->name27($row->price27)</option>");
		else
			echo("<option value='$row->no27^^$row->price27'>$row->name27($row->price27)</option>");
	}
?>
					</select>
                </div>
		...
		<tr>
		 ...
		 <tr>
            ...
            <td width="80%" align="left">
                <div class="form-inline">
                    <input type="text" name="prices" value="" class="form-control form-control-sm" readonly style="border:0">
                </div>
            </td>
        </tr>
		<tr>
            ...
            <td width="80%" align="left">
                <div class="form-inline">
                    <input type="text" name="bigo" value="" class="form-control form-control-sm" />
                </div>
            </td>
        </tr>
        </table>
