		...
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="5000">
		  ...
		  <div class="carousel-inner">
			<div class="carousel-item active">
			  <img src="/my/img/main1.jpg" height="150" alt="First slide" class="d-block w-100">
			</div>
			<div class="carousel-item">
			  <img src="/my/img/main2.jpg" height="150" alt="Second slide" class="d-block w-100" >
			</div>
			<div class="carousel-item">
			  <img src="/my/img/main3.jpg" height="150" alt="Third slide" class="d-block w-100" >
			</div>
		  </div>
