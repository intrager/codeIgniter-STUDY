...
<script>
    function find_text()
	{
		form1.action="/~sale27/graph/lists/text1/" + form1.text1.value + "/text2/" + form1.text2.value;
		form1.submit();
	}
...
?>
	<script src="/~sale27/my/js/Chart.js"></script>
	<script src="/~sale27/my/js/utils.js"></script>
